...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2024 at 11:26 AM
...
CREATE TABLE `guesses` (
  ...
  `cheat` enum('Yes','No') DEFAULT NULL
...
INSERT INTO `guesses` (`id`, `name`, `attempts`, `time`, `randomNumber`, `cheat`) VALUES
(1, 'Jayjaywadawdawdawd', 5, 300, 6, 'No');
